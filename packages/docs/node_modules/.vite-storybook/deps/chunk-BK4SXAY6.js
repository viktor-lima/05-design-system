import {
  require_array_sort
} from "./chunk-P4J3JNM6.js";
import {
  require_array_from,
  require_object_assign
} from "./chunk-6I6ZTYID.js";
import {
  require_safe_get_built_in
} from "./chunk-WUHY37RH.js";
import {
  require_validate_arguments_length
} from "./chunk-EVJGNB7Z.js";
import {
...
var require_web_url_search_params_constructor = __commonJS({
  "../../node_modules/core-js/modules/web.url-search-params.constructor.js"(exports, module) {
    ...
    var utf8Decode = function(octets) {
      ...
      if (codePoint === null || codePoint > 1114111 || codePoint >= 55296 && codePoint <= 57343 || codePoint < (length > 3 ? 65536 : length > 2 ? 2048 : length > 1 ? 128 : 0))
        return null;
      return codePoint;
    };
        ...
        if (decodedChar === "%") {
          ...
          if (byteSequenceLength === 0) {
            ...
            while (sequenceIndex < byteSequenceLength) {
              ...
              if (nextByte !== nextByte || nextByte > 191 || nextByte < 128)
                break;
              if (sequenceIndex === 1) {
                if (octet === 224 && nextByte < 160)
                  break;
                if (octet === 237 && nextByte > 159)
                  break;
                if (octet === 240 && nextByte < 144)
                  break;
                if (octet === 244 && nextByte > 143)
                  break;
              }
            ...
            if (codePoint === null) {
              for (var replacement = 0; replacement < byteSequenceLength; replacement++)
                result += FALLBACK_REPLACER;
              i++;
              continue;
            } else {
    ...
    URLState.prototype = {
          ...
          switch (state) {
            ...
            case FILE_SLASH:
              ...
              if (base && base.scheme === "file") {
                url.host = base.host;
                if (!startsWithWindowsDriveLetter(join(arraySlice(codePoints, pointer), "")) && isWindowsDriveLetter(base.path[0], true))
      ...
      serialize: function() {
        ...
        if (host !== null) {
          ...
          output += "//";
        if (host === null && !url.cannotBeABaseURL && path.length > 1 && path[0] === "")
          output += "/.";
...
//# sourceMappingURL=chunk-BK4SXAY6.js.map
